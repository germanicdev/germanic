...
//!
//! The generated files reside in `$OUT_DIR`, not in the `src/` directory.
//! Rust's `mod` only works for files in the same directory tree.
//! `include!` inlines the content directly.
//!
